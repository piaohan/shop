    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class=" form">
                    <form class="cmxform form-horizontal tasi-form"  method="post" action="/admin/goodsclass/{{$res->id }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="form-group ">
                            <label for="cname" class="control-label col-lg-2">商品类别  *</label>
                            <div class="col-lg-10">
                                <input class=" form-control" id="price" name="cname" type="text" value="{{ $res->cname }}">
                            </div>
                        </div>
                        <div class="form-group">
